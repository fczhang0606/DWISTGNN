...
to reflect the gradual changes of the graph evolution, 
which solves the limitation of insufficient expressive power 
of static graph methods.  % DGC
...
while the higher bands represent faster-varying drastic fluctuations.
Such a separation allows for a more detailed extraction 
of both time and frequency information than previous decomposition methods.  % DT
...
to acquire the representation for prediction.
This interaction between different frequency components 
extracts deeper spatio-temporal features 
compared with the traditional architecture methods.  % FI
...
\label{tab-6}
  ...
  \begin{tabular}{|*{7}{c|}}
    ...
    \hline
    w/o FI-2      & 21.89 & 35.17 & 15.14 & 15.49 & 26.31 & 10.17  \\
    \hline
