...
\textbf{Table.6} shows the results from the ablation study.
On both datasets, full DWISTGNN model outperforms all its variants.
The results of w/o DWT variant proves the function of wavelet transform.

The w/o GCN variant exhibits the greatest drop in accuracy among four graph variants, 
indicating the necessity of capturing spatial dependencies.
The other three graph variants all deteriorates, 
...
The w/o FI-2 variant perform poorly, 
