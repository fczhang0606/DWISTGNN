...
\author[NUE]{Zhang Fengchen}
% \cortext[cor]{Corresponding author}
% \ead{21101002@nue.edu.cn}
\author[THU]{Sun Fuchun\corref{cor}}
\cortext[cor]{Corresponding author}
\ead{fcsun@mail.tsinghua.edu.cn}
\author[NUE]{Lyu Xiao}
...
A $6.73\permil$ RRSE reduction and a $11.41\permil$ MAE reduction 
reveal the effectiveness of the proposed model.
Relevant codes and data are accessible at 
https://github.com/fczhang0606/DWISTGNN.  % experiments
\end{abstract}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Keywords
\begin{keyword}  % 
...
traffic monitoring \cite{kong2023dynamic}\cite{li2024st}\cite{kong2024spatio}, 
financial forecasting \cite{tian2025bimt} and so on.  % fields
\begin{figure}[h]  % [htbp]

  \centering

  \begin{minipage}{0.95\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_1.png}
  \end{minipage}%
...
Dynamic Spatio-Temporal Graph Neural Network with Wavelet Interaction (DWISTGNN).  % DWISTGNN
To solve the limitation of insufficient expressive power 
of static graph methods, 
...
to describe the initial specific graph and 
the dynamic node features 
to reflect the gradual changes of the graph evolution.  % DGC
To allow for a more detailed extraction 
of both time and frequency information than previous decomposition methods, 
...
To extract deeper spatio-temporal features 
compared with the traditional architecture methods, 
every input component of Frequency Interaction (FI) module 
absorbs other component's information and 
...
\begin{figure}[h]  % [htbp]
  ...
  %\begin{minipage}{0.95\textwidth}
    \includegraphics[width=0.98\textwidth]{figs/fig_2.png}
  %\end{minipage}%
...
$T$ denotes the number of timestamps.
\begin{equation}
  \begin{aligned}
...
Differnet wavelet have different characteristics 
which can extract distinct patterns from various datasets.
The db1 wavelet is characterized by orthogonality, good time-domain localization 
and poor frequency-domain localization, 
making it suitable for analyzing step-like or blocky signals.
The sym2 wavelet is characterized by approximate symmetry, 
reduced phase distortion and increased smoothness.
The coif1 wavelet features dual vanishing moments, 
resulting in more accurate sampling approximation.
...
\begin{figure}[h]  % [htbp]
  ...
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_3.1.png}
    \centerline{\footnotesize (1)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_3.2.png}
    \centerline{\footnotesize (2)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_3.3.png}
    \centerline{\footnotesize (3)}
  \end{minipage}%

  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_3.4.png}
    \centerline{\footnotesize (4)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_3.5.png}
    \centerline{\footnotesize (5)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_3.6.png}
...
\begin{figure}[h]  % [htbp]
  ...
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_4.1.png}
    \centerline{\footnotesize (1)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_4.2.png}
    \centerline{\footnotesize (2)}
  \end{minipage}%
...
\begin{figure}[h]  % [htbp]
  ...
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_5.1.png}
    \centerline{\footnotesize (1)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_5.2.png}
    \centerline{\footnotesize (2)}
  \end{minipage}%

  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_5.3.png}
    \centerline{\footnotesize (3)}
  \end{minipage}%
  \hspace{-0.5em}
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_5.4.png}
    \centerline{\footnotesize (4)}
  \end{minipage}%
...
\begin{figure}[h]  % [htbp]
  ...
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_6.1.png}
    \centerline{\footnotesize (1)}
  \end{minipage}%
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_6.2.png}
    \centerline{\footnotesize (2)}
  \end{minipage}%

  \begin{minipage}{0.23\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_6.3.png}
    \centerline{\footnotesize (3)}
  \end{minipage}%
  \begin{minipage}{0.23\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_6.4.png}
    \centerline{\footnotesize (4)}
  \end{minipage}%
  \begin{minipage}{0.23\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_6.5.png}
    \centerline{\footnotesize (5)}
  \end{minipage}%
  \begin{minipage}{0.23\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_6.6.png}
    \centerline{\footnotesize (6)}
  \end{minipage}%
...
Seven variants of DWISTGNN are created by 
...
\item \textbf{w/o STD+COM}: 
      This variant replaces the graph structure 
      constructed by the DGC module 
      with the gradual changing graph 
      to evaluate the capability of capturing graph dynamicity.
\item \textbf{w/o STD+DYN}: 
      This variant replaces the graph structure 
      constructed by the DGC module 
      with the compensatory graph 
      to evaluate the capability of capturing graph dynamicity.
\item \textbf{w/o GCN}: 
...
\item \textbf{w/o FI-1}: 
      ...
      Instead, the outputs from the previous modules only 
      undergo a single round of interaction.
\item \textbf{w/o FI-2}: 
      This variant omits the FI module, 
      which models the deep interactions between different frequency components.
...
\label{tab-6}
  ...
  \begin{tabular}{|*{7}{c|}}
    ...
    \hline
    w/o DYN+COM   & 18.39 & 29.92 & 12.35 & 13.43 & 23.32 & 8.77  \\
    \hline
    w/o STD+COM   & 18.04 & 29.67 & 12.19 & 13.24 & 23.03 & 8.71  \\
    \hline
    w/o STD+DYN   & 18.05 & 29.72 & 12.21 & 13.28 & 23.10 & 8.92  \\
    \hline
    w/o GCN       & 18.36 & 29.94 & 12.29 & 13.65 & 23.46 & 8.94  \\
    \hline
    w/o FI-1      & 18.16 & 29.82 & 12.19 & 13.31 & 22.94 & 8.73  \\
    \hline
    w/o FI-2      & 18.22 & 29.72 & 12.21 & 13.37 & 22.97 & 8.95  \\
    \hline
...
\textbf{Table.6} presents the results from the ablation study.
On both datasets, full DWISTGNN model outperforms all its variants.
The results of w/o DWT variant prove the function of wavelet transform.

The w/o GCN variant exhibits the most significant drop 
in accuracy among four graph variants, 
indicating the necessity of capturing spatial dependencies.
The other three graph variants all deteriorate, 
demonstrating the stability and effectiveness of 
the initial static graph, the gradual changing graph and the compensatory graph.
The smaller ablation error 
from the w/o STD+COM variant compared with the w/o DYN+COM variant 
indicates that the contribution of gradual changing graph is 
greater than the initial static graph.

The w/o FI-2 variant performs poorly, 
which is a strong support of the necessity of interaction.
The improved performance and the ablation error 
of the w/o FI-1 variant 
show that 
the performance of the model becomes better 
as the number of interaction rounds increases.
...
\begin{figure}[h]  % [htbp]
  ...
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_7.1.png}
    \centerline{\footnotesize (1)}
  \end{minipage}%
  %\hspace{1.0em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_7.2.png}
    \centerline{\footnotesize (2)}
  \end{minipage}%
  %\hspace{1.0em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_7.3.png}
    \centerline{\footnotesize (3)}
  \end{minipage}%

  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_7.4.png}
    \centerline{\footnotesize (4)}
  \end{minipage}%
  %\hspace{1.0em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_7.5.png}
    \centerline{\footnotesize (5)}
  \end{minipage}%
  %\hspace{1.0em}
  \begin{minipage}{0.33\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/fig_7.6.png}
    \centerline{\footnotesize (6)}
  \end{minipage}%
...
For example, the DWT used in DT module 
...
to further improve performance and adapt to more scenarios.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 6-Conclusion %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
